...
if not usegui:
    ...
    RIin=[10,25] # Recurrence interval of interest options are 2,10,25,50,100,200,500
    basename='a000'
...
if usegui:
    ...
    RIin=arcpy.GetParameter(7) # Recurrence interval of interest options are 2,10,25,50,100,200,500
    basename=arcpy.GetParameterAsText(8)
    out_tmp_dir=arcpy.GetParameterAsText(9)
...
for RI in RIin:
    ...
    if Region==1:
        ...
        c=[0.656,0.537,0.5,0.414,0.373,334,0.299,0.256]
