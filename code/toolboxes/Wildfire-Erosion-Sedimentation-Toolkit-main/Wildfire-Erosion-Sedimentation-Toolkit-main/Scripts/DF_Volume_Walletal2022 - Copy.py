...
ZonalStatisticsAsTable(burn_basin,uid_field, Temp, temp_tbl, "NODATA", "MEAN")
...
ZonalStatisticsAsTable(burn_basin,uid_field, conifer_rc, conifer_tbl, "NODATA", "MEAN")
...
ZonalStatisticsAsTable(burn_basin,uid_field, MGO_wtshd, MGO_tbl, "NODATA", "MEAN")
...
ZonalStatisticsAsTable(burn_basin,uid_field, CST_wtshd, CS_tbl, "NODATA", "MEAN")
...
ZonalStatisticsAsTable(burn_basin,uid_field, runoffaoi, runoff_tbl, "NODATA", "MEAN")
...
ZonalStatisticsAsTable(burn_basin,uid_field, inDEM, E_tbl, "NODATA", "MEAN")
