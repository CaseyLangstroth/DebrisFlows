...
```{r image, fig.cap = "database structure", fig.align = 'center', out.width = '100%', echo= TRUE}
knitr::include_graphics("C:\\Users\\clang\\Documents\\USU\\DF_Areas\\debris_flow_stats\\code\\RProjects\\website\\RDS_website\\database_structure.png") 
## leaving the echo as true because I still have no idea why the image isn't showing. it appears with knitting, but not on the website.
```
## Code for designing and building my database structure in R
...
df_volumes = read.csv('//data//data_sheets//processed_summary_data//Gross_Summary_Vol_tdf.csv', header = T, na.strings = ' ')
df_gsd = read.csv('//data//data_sheets//processed_summary_data//df_gsd.csv', header = T, na.strings = ' ')
df_morphology = read.csv('//data//data_sheets//processed_summary_data//df_morphology.csv', header = T, na.strings = ' ')
reach_morphology = read.csv('//data//data_sheets//processed_summary_data//reach_morphology.csv', header = T, na.strings = ' ')
channel_morphology = read.csv('//data//data_sheets//processed_summary_data//channel_morphology.csv', header = T, na.strings = ' ')
subcatch_morphology = read.csv('//data//data_sheets//processed_summary_data//subcatchment_morphology.csv', header = T, na.strings = ' ')
